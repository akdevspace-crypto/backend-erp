import { candidateUpdateSchema } from './src/modules/hr/schema.js';
...
async function main() {
  ...
  try {
    ...
    const data = candidateUpdateSchema.parse(rawBody);
    console.log('Parsed data:', data);
    
    const staff = await placeCandidate(candidate.tenantId, candidate.unitId, candidate.id, data);
